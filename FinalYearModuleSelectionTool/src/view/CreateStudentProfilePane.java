...
public class CreateStudentProfilePane extends GridPane {
	...
	//methods to retrieve and set the form selection/input
	public Course getSelectedCourse() {
		return cboCourses.getSelectionModel().getSelectedItem();
	}
	
	public void setCoursetxt (int i) {
	...
	public void setStudentPnumbertxt(String pnumb) {
		txtPnumber.setText(pnumb);
	}
	...
	public void setStudentfNametxt(String fname) {
		txtFirstName.setText(fname);
	}
	
	public void setStudentlNametxt(String lname) {
		txtSurname.setText(lname);
	}
	...
	public void setStudentlEmail(String email) {
